...
impl P2PServer {
    ...
    pub async fn initialize_server(bootstrap_nodes: Option<String>, client_behaviour: ClientBehaviour) -> Result<(), Box<dyn Error>> {
        ...
        let gossipsub_config = gossipsub::ConfigBuilder::default()
            ...
            .max_transmit_size(16777216) // maximum message size that the network will accept
            .build()
            .expect("Valid config");
        ...
        let (command_sender, command_receiver) = mpsc::channel(1000000);
        let (event_sender, event_receiver) = mpsc::channel(1000000);
